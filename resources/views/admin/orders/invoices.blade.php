...
@section('page-script')
  ...
  <script src="{{asset('js/admin/jsInvoices.js')}}"></script>
@endsection


@section('content')
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Admin /</span> Orders Invoices
  </h4>
  <div class="row">
    <div class="col-sm-12">
      <ul class="nav nav-tabs widget-nav-tabs pb-1 gap-2 mx-1 d-flex flex-nowrap" role="tablist">
        <li class="nav-item">
          <a style="width: 100px !important; height: auto !important;" href="/admin/invoices/{{base64_encode(0)}}"
        ...
        <li class="nav-item">
          <a style="width: 115px !important; height: auto !important;" href="/admin/invoices/{{base64_encode(1)}}"
        ...
        <li class="nav-item">
          <a style="width: 110px !important; height: auto !important;" href="/admin/invoices/{{base64_encode(2)}}"
            ...
            @if(count($aInvoices))
              @foreach($aInvoices as $iKey => $aInvoice)
                <tr>
                  ...
                  <td>
                    <a title="View Details" href="/admin/invoice/details/{{base64_encode($aInvoice->id)}}" class="badge bg-info">View</a>
                    <a title="Download Invoice" href="/admin/invoice/download/{{base64_encode($aInvoice->id)}}" class="badge bg-primary">Download</a>
                  </td>
                </tr>
              @endforeach
            @endif
