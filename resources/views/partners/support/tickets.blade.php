...
@section('page-script')
  ...
  <script src="{{asset('js/partner/jsTickets.js')}}"></script>
@endsection

@section('content')
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Partner /</span> Tickets
  </h4>
      ...
      <div class="nav-align-left">
        <ul class="nav nav-pills" role="tablist">
          <li class="nav-item " role="presentation">
            <a href="/partner/tickets/{{base64_encode("0")}}" class="nav-link {{($iStatus == 0 ? "active" : "")}}" >
              <b>New</b>
            </a>
          </li>
          <li class="nav-item" role="presentation">
            <a href="/partner/tickets/{{base64_encode("1")}}" class="nav-link {{($iStatus == 1 ? "active" : "")}}" >
              <b>Open</b>
            </a>
          </li>
          <li class="nav-item" role="presentation">
            <a href="/partner/tickets/{{base64_encode("2")}}" class="nav-link {{($iStatus == 2 ? "active" : "")}}" >
              <b>Closed</b>
            </a>
          </li>
        </ul>
              ...
              @if(count($aTickets))
                @foreach($aTickets as $iKey => $aTicket)
                  <tr>
                    ...
                    <td>
                      <a href="/partner/ticket/details/{{base64_encode($aTicket->id)}}" class="badge bg-primary">Open Ticket</a>
                    </td>
                  </tr>
                @endforeach
              @endif
