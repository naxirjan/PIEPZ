...
<h4 class="fw-bold py-3 mb-4">
   <span class="text-muted fw-light">Partner  /</span> Orders Inoivces
</h4>
<!-- Scrollable -->
      ...
      <table id="example" class="table" >
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>{{ $string1}}</td>
               <td>12/4/2023</td>
               <td><a href="#"><span class="badge bg-warning">View</span></a> <a href="#"><span class="badge bg-warning">Download</span></a></td>
            </tr>
            @endfor
         </tbody>
      </table>
