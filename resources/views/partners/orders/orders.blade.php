...
@section('page-script')
  ...
  <script src="{{asset('js/partner/jsOrders.js')}}"></script>
@endsection
...
@section('content')
  <h4 class="fw-bold py-3 mb-4">
    ...
    <a href="/partner/create-new-order" type="button" style="float:right;" class="btn rounded-pill btn-icon btn-label-primary waves-effect" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="Create New Order">
  ...
  <div class="row">
    <div class="col-sm-12">
      <ul class="nav nav-tabs widget-nav-tabs pb-1 gap-2 mx-1 d-flex flex-nowrap" role="tablist">
        <li class="nav-item">
          <a style="width: 90px !important; height: auto !important;" href="/partner/orders/{{base64_encode(0)}}"
        ...
        <li class="nav-item">
          <a style="width: 140px !important; height: auto !important;" href="/partner/orders/{{base64_encode(1)}}"
        ...
        <li class="nav-item">
          <a style="width: 135px !important; height: auto !important;" href="/partner/orders/{{base64_encode(2)}}"
        ...
        <li class="nav-item">
          <a style="width: 130px !important; height: auto !important;" href="/partner/orders/{{base64_encode(3)}}"
            ...
            @if(count($aOrders))
              @foreach($aOrders as $iKey => $aOrder)
                <tr>
                  ...
                  <td><a href="/partner/order/details/{{base64_encode($aOrder->id)}}" class="badge bg-info">View</a> </td>
                </tr>
              @endforeach
            @endif
            </tbody>
