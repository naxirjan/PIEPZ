...
<h4 class="fw-bold py-3 mb-4">
   <span class="text-muted fw-light">Partner /</span> Order Details
  <!-- Back -->
  <span style="float: right;">
    <a href="/partner/orders/{{base64_encode(($aOrderData[0]->status ?? ""))}}" type="button"
...
<div class="row">
   ...
   <div class="col-lg-8 mb-4">
      <div class="card h-100">
         ...
         @foreach($aOrderData as $ordersProducts)
            <ul class="p-0 m-0">
                  <li class="d-flex mb-4 pb-1">
                     <div class="me-3">
                        <img src=" {{$ordersProducts->image}}" alt="User" class="rounded" width="46">
                     </div>
                     <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                        <div class="me-2">
                           <h6 class="mb-0">{{$ordersProducts->name}}</h6>
                           <small class="text-muted d-block">Item: {{$ordersProducts->total_item}}</small>
                           <small class="text-muted d-block">SKU: {{$ordersProducts->sku}}</small>
                        </div>
                        <div class="user-progress d-flex align-items-center gap-1">

                           <p class="mb-0 fw-semibold">€{{$ordersProducts->total_price}}</p>
                        </div>
                     </div>
                  </li>
               </ul>
