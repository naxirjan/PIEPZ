  ...
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      ...
      @if(Session::has('message'))
        ...
        @endif
      <!-- Account -->
      <form  method="POST" action="{{ route('partner.update.profile') }}" enctype="multipart/form-data">
      @csrf
      <div class="card-body">
      ...
      <!-- /Account -->
       ...
       <div class="card mb-4">
                                ...
                                <div class="card-body">
                                  <form id="formChangePassword" method="POST" action="{{ route('partner.change.password') }}">
                                  @csrf 
