                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        @foreach($product->images as $img)
                                            <figure class="border-radius-10">
                                                <img src="{{asset('storage/'.$img->media_url)}}" alt="product image">
                                            </figure>
                                        @endforeach 
                                        </div>
                                        <!-- THUMBNAILS -->
                                        ...
                                        @foreach($product->images as $img)
                                            <div><img src="{{asset('storage/'.$img->media_url)}}" alt="product image"></div>
                                        @endforeach    
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                    <div class="social-icons single-share">
                                        <ul class="text-grey-5 d-inline-block">
                                            ...
                                            <li class="social-facebook"><a href="#"><img
                                                        src="{{asset('front-assets/imgs/theme/icons/icon-facebook.svg')}}" alt=""></a></li>
                                            <li class="social-twitter"> <a href="#"><img
                                                        src="{{asset('front-assets/imgs/theme/icons/icon-twitter.svg')}}" alt=""></a></li>
                                            <li class="social-instagram"><a href="#"><img
                                                        src="{{asset('front-assets/imgs/theme/icons/icon-instagram.svg')}}" alt=""></a>
                                            </li>
                                            <li class="social-linkedin"><a href="#"><img
                                                        src="{{asset('front-assets/imgs/theme/icons/icon-pinterest.svg')}}" alt=""></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-12 col-sm-6">
                                            <div class="product-cart-wrap small hover-up">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="shop-product-right.html" tabindex="0">{{$r->name}}</a></h2>
