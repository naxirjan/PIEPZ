          ...
          <div class="col-12 mx-auto">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" id="fullname" class="form-control" placeholder="John Doe"  name="company" required />
              </div>
              <div class="col-md-6"></div>
              <div class="col-md-6">
                <label class="form-label" for="fullname">Name</label>
                <input type="hidden" name="first_order_charges" value="{{$order?0:50}}">
                <input type="text" id="fullname" class="form-control" placeholder="John Doe"  name="name" required />
              </div>
              <div class="col-md-6">
                <label class="form-label" for="fullname">Surname</label>
                <input type="text" id="fullname" class="form-control" placeholder="John Doe"   name="surname" required/>
              </div>
              <div class="col-md-6">
                <label class="form-label" for="state">Country</label>
                <select id="state" class="select2 form-select country" data-allow-clear="true"  name="country" required>
              @if($countries->count())  
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="pincode" class="form-control" placeholder="658468"  name="postalcode" required />
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="city" class="form-control" placeholder="Jackson"  name="city" required/>
              </div>
              <div class="col-12">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="phone" class="form-control phone-mask" placeholder="658 799 8941" aria-label="658 799 8941"  name="mobile" required />
              </div>
              <div class="col-md-6">
                <label class="form-label" for="alt-num">Other landline or mobile phone</label>
                <input type="text" id="alt-num" class="form-control phone-mask" placeholder="658 799 8941"  name="phone" required />
              </div>
              <!-- <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group input-group-merge">
                  <input class="form-control" type="text" required id="email" name="email" placeholder="john.doe" aria-label="john.doe" aria-describedby="email3"  required/>
