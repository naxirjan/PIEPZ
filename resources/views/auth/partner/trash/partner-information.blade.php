        ...
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center mb-4 mt-2">
            <a href="{{url('/')}}" class="app-brand-link gap-2">
              <span class="app-brand-text demo text-body fw-bold ms-1">B2B Partner Information</span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-1 pt-2">Company details</h4>

          <form id="formAuthentication" class="mb-3" action="{{route('partner.package')}}" method="POST">
          @csrf
            <!-- card start here -->
