...
<!-- Status-->
    ...
    <div class="row">
		...
		<button id="idBtnSearch" class="btn btn-success btn-sm me-5 waves-effect waves-light" type="button">Search <i class="ti ti-search ti-sm"></i></button></div>
        <div class="col-xl-4 col-md-4 col-6 mb-4"></div>
        <div class="col-xl-4 col-md-4 col-6 mb-4 text-center">
		<button id="idBtnResetFilter" class="btn btn-info btn-sm me-5 waves-effect waves-light" type="button">
                Reset Filters<i class="ti ti-refresh ti-sm"></i></button>
	</div>
    </div>
