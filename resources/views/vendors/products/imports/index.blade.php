...
var form_data_ ={};
  ...
  $("select.select1").each(function(i,val){
    ...
    if ($(val).val()!=" " && $(sel).children(0).val()!=" " && $(val).val()!=null &&  $(sel).children(0).val()!=null && $(val).val()===$(val).val().toUpperCase()) {
...
@section('content')
  <h4 class="fw-bold py-3 mb-4">
    <span class="text-muted fw-light">Vendor /</span> Import Products
    <!-- Back -->
    <a href="/vendor/products" type="button" style="float:right;"
...
<div class="row">
  ...
  <div class="col-lg-12 mb-4">
   ...
   <a href="/vendor/feed/products" class="btn btn-primary btn-next show_exl_header waves-effect waves-light" >
     <span class="align-middle d-sm-inline-block d-none me-sm-1 me-0">Upload File</span>
     <i class="ti ti-arrow-right ti-xs"></i></a>
...
<div class="card">
  ...
  <div class="table-responsive text-nowrap hide">
    ...
    <input class="label btn-primary mt-2 mb-3" type="button" id="upload" value="Import Products" onclick="Display()" />
  </div>
</div>
