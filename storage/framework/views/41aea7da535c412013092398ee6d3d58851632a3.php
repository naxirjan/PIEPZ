      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          <li class="d-flex mb-4 pb-1 align-items-center">
            <img src="<?php echo e(asset('assets/img/icons/brands/chrome.png')); ?>" alt="Chrome" height="28" class="me-3 rounded">
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <img src="<?php echo e(asset('assets/img/icons/brands/safari.png')); ?>" alt="Safari" height="28" class="me-3 rounded">
            <div class="d-flex w-100 align-items-center gap-2">
              <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                <div>
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <img src="<?php echo e(asset('assets/img/icons/brands/firefox.png')); ?>" alt="Firefox" height="28" class="me-3 rounded">
            <div class="d-flex w-100 align-items-center gap-2">
              <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                <div>
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <img src="<?php echo e(asset('assets/img/icons/brands/opera.png')); ?>" alt="Opera" height="28" class="me-3 rounded">
            <div class="d-flex w-100 align-items-center gap-2">
              <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                <div>
          ...
          <li class="d-flex mb-4 pb-1 align-items-center">
            <img src="<?php echo e(asset('assets/img/icons/brands/edge.png')); ?>" alt="Edge" height="28" class="me-3 rounded">
            <div class="d-flex w-100 align-items-center gap-2">
              <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                <div>
          ...
          <li class="d-flex align-items-center">
            <img src="<?php echo e(asset('assets/img/icons/brands/brave.png')); ?>" alt="Brave" height="28" class="me-3 rounded">
            <div class="d-flex w-100 align-items-center gap-2">
              <div class="d-flex justify-content-between flex-grow-1 flex-wrap">
                <div>
        ...
        <ul class="p-0 m-0">
          <li class="mb-3 pb-1 d-flex">
            <div class="d-flex w-50 align-items-center me-3">
              <img src="<?php echo e(asset('assets/img/icons/brands/laravel-logo.png')); ?>" alt="laravel-logo" class="me-3" width="35" />
              <div>
          ...
          <li class="mb-3 pb-1 d-flex">
            <div class="d-flex w-50 align-items-center me-3">
              <img src="<?php echo e(asset('assets/img/icons/brands/figma-logo.png')); ?>" alt="figma-logo" class="me-3" width="35" />
              <div>
          ...
          <li class="mb-3 pb-1 d-flex">
            <div class="d-flex w-50 align-items-center me-3">
              <img src="<?php echo e(asset('assets/img/icons/brands/vue-logo.png')); ?>" alt="vue-logo" class="me-3" width="35" />
              <div>
          ...
          <li class="mb-3 pb-1 d-flex">
            <div class="d-flex w-50 align-items-center me-3">
              <img src="<?php echo e(asset('assets/img/icons/brands/react-logo.png')); ?>" alt="react-logo" class="me-3" width="35" />
              <div>
          ...
          <li class="mb-3 pb-1 d-flex">
            <div class="d-flex w-50 align-items-center me-3">
              <img src="<?php echo e(asset('assets/img/icons/brands/bootstrap-logo.png')); ?>" alt="bootstrap-logo" class="me-3" width="35" />
              <div>
          ...
          <li class="d-flex">
            <div class="d-flex w-50 align-items-center me-3">
              <img src="<?php echo e(asset('assets/img/icons/brands/sketch-logo.png')); ?>" alt="sketch-logo" class="me-3" width="35" />
              <div>
        ...
        <ul class="timeline ms-1 mb-0">
          ...
          <li class="timeline-item timeline-item-transparent ps-4">
            ...
            <div class="timeline-event">
              ...
              <p class="mb-2">Sent by Mollie Dixon <img src="<?php echo e(asset('assets/img/avatars/4.png')); ?>" class="rounded-circle me-3" alt="avatar" height="24" width="24"></p>
              <div class="d-flex flex-wrap gap-2 pt-1">
                <a href="javascript:void(0)" class="me-3">
                  <img src="<?php echo e(asset('assets/img/icons/misc/doc.png')); ?>" alt="Document image" width="15" class="me-2">
                  <span class="fw-semibold text-heading">App Guidelines</span>
                </a>
                <a href="javascript:void(0)">
                  <img src="<?php echo e(asset('assets/img/icons/misc/xls.png')); ?>" alt="Excel image" width="15" class="me-2">
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\piep-frontend\resources\views/content/dashboard/dashboards-crm.blade.php ENDPATH**/ ?>