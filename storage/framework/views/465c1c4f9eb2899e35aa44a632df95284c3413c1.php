...
<?php $__env->startSection('title', 'Cards basic - UI elements'); ?>
...
<div class="row mb-5">
  <div class="col-md-6 col-lg-4 mb-3">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/2.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
  ...
  <div class="col-md-6 col-lg-4 mb-3">
    <div class="card h-100">
      ...
      <img class="img-fluid" src="<?php echo e(asset('assets/img/elements/10.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
  ...
  <div class="col-md-6 col-lg-4 mb-3">
    <div class="card h-100">
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <h6 class="card-subtitle text-muted">Support card subtitle</h6>
        <img class="img-fluid d-flex mx-auto my-4 rounded" src="<?php echo e(asset('assets/img/elements/4.jpg')); ?>" alt="Card image cap" />
        <p class="card-text">Bear claw sesame snaps gummies chocolate.</p>
        <a href="javascript:void(0);" class="card-link">Card link</a>
        <a href="javascript:void(0);" class="card-link">Another link</a>
      </div>
...
<div class="row mb-5">
  ...
  <div class="col-md-6 col-lg-4">
    ...
    <div class="card mb-4">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/5.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <p class="card-text">
          Some quick example text to build on the card title and make up the bulk of the card's content.
        </p>
  ...
  <div class="col-md-6 col-lg-4">
    ...
    <div class="card">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/7.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">
...
<div class="row mb-5">
  <div class="col-md-6 col-xl-4">
    <div class="card mb-3">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/13.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">
  ...
  <div class="col-md-6 col-xl-4">
    <div class="card mb-3">
      ...
      <img class="card-img-bottom" src="<?php echo e(asset('assets/img/elements/1.jpg')); ?>" alt="Card image cap" />
    </div>
  </div>
  <div class="col-md-6 col-xl-4">
    <div class="card bg-dark border-0 text-white">
      <img class="card-img" src="<?php echo e(asset('assets/img/elements/8.jpg')); ?>" alt="Card image" />
...
<div class="row mb-5">
  <div class="col-md">
    <div class="card mb-3">
      <div class="row g-0">
        <div class="col-md-4">
          <img class="card-img card-img-left" src="<?php echo e(asset('assets/img/elements/9.jpg')); ?>" alt="Card image" />
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
  ...
  <div class="col-md">
    <div class="card mb-3">
      <div class="row g-0">
        ...
        <div class="col-md-4">
          <img class="card-img card-img-right" src="<?php echo e(asset('assets/img/elements/12.jpg')); ?>" alt="Card image" />
        </div>
      </div>
    </div>
  </div>
...
<div class="card-group mb-5">
  <div class="card">
    <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/4.jpg')); ?>" alt="Card image cap" />
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">
        This is a wider card with supporting text below as a natural lead-in to additional content. This content is a
  ...
  <div class="card">
    <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/1.jpg')); ?>" alt="Card image cap" />
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
      <p class="card-text">
...
<div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
  ...
  <div class="col">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/10.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
  ...
  <div class="col">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/14.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
  ...
  <div class="col">
    <div class="card h-100">
      <img class="card-img-top" src="<?php echo e(asset('assets/img/elements/15.jpg')); ?>" alt="Card image cap" />
      <div class="card-body">
        <h5 class="card-title">Card title</h5>
        <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\piep-frontend\resources\views/content/cards/cards-basic.blade.php ENDPATH**/ ?>