...
<?php $__env->startSection('title', 'User View - Pages'); ?>
...
<script src="<?php echo e(asset('assets/js/modal-edit-user.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/modal-edit-cc.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/modal-add-new-cc.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/modal-add-new-address.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/app-user-view.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/app-user-view-billing.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<div class="row">
      ...
      <div class="card-body">
        <div class="user-avatar-section">
          <div class=" d-flex align-items-center flex-column">
            <img class="img-fluid rounded mb-3 pt-1 mt-4" src="<?php echo e(asset('assets/img/avatars/15.png')); ?>" height="100" width="100" alt="User avatar" />
  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-4">
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/account')); ?>"><i class="ti ti-user-check me-1 ti-xs"></i>Account</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/security')); ?>"><i class="ti ti-lock me-1 ti-xs"></i>Security</a></li>
      ...
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/notifications')); ?>"><i class="ti ti-bell me-1 ti-xs"></i>Notifications</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/connections')); ?>"><i class="ti ti-link me-1 ti-xs"></i>Connections</a></li>
    </ul>
    <!--/ User Pills -->
      ...
      <div class="card-body">
        <div class="added-cards">
          <div class="cardMaster border p-3 rounded mb-3">
            <div class="d-flex justify-content-between flex-sm-row flex-column">
              <div class="card-information">
                <img class="mb-3 img-fluid" src="<?php echo e(asset('assets/img/icons/payments/mastercard.png')); ?>" alt="Master Card">
          ...
          <div class="cardMaster border p-3 rounded mb-3">
            <div class="d-flex justify-content-between flex-sm-row flex-column">
              <div class="card-information">
                <img class="mb-3 img-fluid" src="<?php echo e(asset('assets/img/icons/payments/visa.png')); ?>" alt="Master Card">
          ...
          <div class="cardMaster border p-3 rounded">
            <div class="d-flex justify-content-between flex-sm-row flex-column">
              <div class="card-information">
                <img class="mb-3 img-fluid" src="<?php echo e(asset('assets/img/icons/payments/american-ex.png')); ?>" alt="Visa Card">
        ...
        <div class="row">
          <div class="col-xl-7 col-12">
            <dl class="row mb-0">
              ...
              <dd class="col-sm-8"><?php echo e(config('variables.templateName')); ?></dd>
...
<?php echo $__env->make('_partials/_modals/modal-edit-cc', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('_partials/_modals/modal-add-new-address', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('_partials/_modals/modal-add-new-cc', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('_partials/_modals/modal-upgrade-plan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- /Modal -->

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PIEPZ\resources\views/content/apps/app-user-view-billing.blade.php ENDPATH**/ ?>