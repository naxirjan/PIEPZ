  ...
  <div class="col-lg-8 mb-4">
    <div class="card h-100">
      ...
      <div>
          ...
          <input type="text" class="form-control" id="defaultFormControlInput" placeholder="simply dummy text of the printing and typesetting industry" aria-describedby="defaultFormControlHelp"  value="<?php echo e($product->name); ?>" />
        </div>
      <!-- Product Description  -->
      <hr class="my-5">
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\piep-frontend\resources\views/admin/products/product-edit.blade.php ENDPATH**/ ?>