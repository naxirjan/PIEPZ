        ...
        <tbody>
            <?php if(count($products)): ?>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo e(route('admin.edit.product',['id'=>$product->id])); ?>" class="text-body"><?php echo e($product->name); ?></a></td>
                    <td><?php echo e($product->price); ?></td>
                    <td><?php echo e($product->stock); ?></td>
                    <td><div class="d-flex align-items-center"><a href="<?php echo e(route('admin.edit.product',['id'=>$product->id])); ?>" class="text-body"><i class="ti ti-edit ti-sm me-2"></i></a><a href="<?php echo e(route('admin.delete.product',['id'=>$product->id])); ?>" class="text-body delete-record " id="confirm-color"><i class="ti ti-trash ti-sm mx-2"></i></a><a href="javascript:;" class="text-body dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical ti-sm mx-1"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="<?php echo e(route('vendor.product.view',['id'=>$product->id])); ?>" class="dropdown-item">View</a><a href="javascript:;" class="dropdown-item">Suspend</a></div></div></td>
                </tr>
