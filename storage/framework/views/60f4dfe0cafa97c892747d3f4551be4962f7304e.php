...
<script src="<?php echo e(asset('assets/js/app-user-view-account.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<div class="row">
  ...
  <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
    ...
    <ul class="nav nav-pills flex-column flex-md-row mb-4">
      ...
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/security')); ?>"><i class="ti ti-lock ti-xs me-1"></i>Security</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/billing')); ?>"><i class="ti ti-currency-dollar ti-xs me-1"></i>Billing & Plans</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/notifications')); ?>"><i class="ti ti-bell ti-xs me-1"></i>Notifications</a></li>
      <li class="nav-item"><a class="nav-link" href="<?php echo e(url('app/user/view/connections')); ?>"><i class="ti ti-link ti-xs me-1"></i>Connections</a></li>
    </ul>
    <!--/ User Pills -->
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex">
                <a href="javascript:void(0)" class="me-3">
                  <img src="<?php echo e(asset('assets/img/icons/misc/pdf.png')); ?>" alt="PDF image" width="15" class="me-2">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex align-items-center avatar-group">
                ...
                <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Marrie Patty">
                  <img src="<?php echo e(asset('assets/img/avatars/12.png')); ?>" alt="Avatar" class="rounded-circle">
                </div>
                <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Jimmy Jackson">
                  <img src="<?php echo e(asset('assets/img/avatars/9.png')); ?>" alt="Avatar" class="rounded-circle">
                </div>
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Naxir\PIEPZ\resources\views/content/apps/app-user-view-account.blade.php ENDPATH**/ ?>