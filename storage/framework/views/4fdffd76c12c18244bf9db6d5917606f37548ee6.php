      ...
      <div class="swiper-wrapper">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                <img src="<?php echo e(asset('assets/img/illustrations/card-website-analytics-1.png')); ?>" alt="Website Analytics" width="170" class="card-website-analytics-img">
              </div>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="row">
            ...
            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
              <img src="<?php echo e(asset('assets/img/illustrations/card-website-analytics-2.png')); ?>" alt="Website Analytics" width="170" class="card-website-analytics-img">
            </div>
          </div>
        </div>
        <div class="swiper-slide">
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          ...
          <li class="d-flex align-items-center mb-4">
            <img src="<?php echo e(asset('assets/svg/flags/fr.svg')); ?>" alt="User" class="rounded-circle me-3" width="34">
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
                <div class="d-flex align-items-center">
          ...
          <li class="d-flex align-items-center">
            <img src="<?php echo e(asset('assets/svg/flags/cn.svg')); ?>" alt="User" class="rounded-circle me-3" width="34">
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
                <div class="d-flex align-items-center">
...
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\piep-frontend\resources\views/content/dashboard/dashboards-analytics.blade.php ENDPATH**/ ?>